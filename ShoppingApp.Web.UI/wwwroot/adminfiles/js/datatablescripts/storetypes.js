    ...
    var demo = function () {
        ...
        var options = {
            ...
            data: {
                ...
                source: {
                    read: {
                        url: '/admin/storetype/getpagedstoretypes/'
                    },
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    autoHide: false,
                    template: function (row) {
                        return '\<a href="/admin/storetype/edit/' + row.globalId + '"class="btn btn-sm btn-clean btn-icon" title="Edit details">\
        ...
        $('#setStatusActive').on('click', function () {
            ...
            if (datatable.nodes().length > 0) {
                ...
                console.log(data);
                $.ajax({
                    url: "admin/storetype/UpdateStatusRange/",
                    method: "Post",
                    data: data,
        ...
        $('#deleteSelectedBtn').on('click', function () {
            ...
            if (datatable.nodes().length > 0) {
                ...
                console.log(data);
                $.ajax({
                    url: "admin/storetype/deleterange/",
                    method: "Post",
                    data: data,
                    success: function (response) {
                        Swal.fire({
