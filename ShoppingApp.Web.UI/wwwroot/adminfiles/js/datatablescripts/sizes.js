    ...
    var demo = function () {
        ...
        var options = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    autoHide: false,
                    template: function (row) {
                        return '\<a href="/admin/size/edit/' + row.globalId + '"class="btn btn-sm btn-clean btn-icon" title="Edit details">\
        ...
        $('#setStatusActive').on('click', function () {
            ...
            if (datatable.nodes().length > 0) {
                ...
                console.log(data);
                $.ajax({
                    url: "admin/size/UpdateStatusRange/",
                    method: "Post",
                    data: data,
