    ...
    var demo = function () {
        ...
        var options = {
            ...
            data: {
                ...
                source: {
                    read: {
                        url: '/admin/color/getpagedcolors/'
                    },
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    autoHide: false,
                    template: function (row) {
                        return '\<a href="/admin/color/edit/' + row.globalId + '"class="btn btn-sm btn-clean btn-icon" title="Edit details">\
        ...
        $('#setStatusActive').on('click', function () {
            ...
            if (datatable.nodes().length > 0) {
                ...
                console.log(data);
                $.ajax({
                    url: "admin/color/UpdateStatusRange/",
                    method: "Post",
                    data: data,
