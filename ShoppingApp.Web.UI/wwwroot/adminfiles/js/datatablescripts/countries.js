    ...
    var demo = function () {
        ...
        var options = {
            ...
            data: {
                ...
                source: {
                    read: {
                        url: '/admin/country/getpagedcountries/'
                    },
                },
            ...
            columns: [
                ...
                },
                {
                    ...
                    autoHide: false,
                    template: function (row) {
                        return '\<a href="/admin/country/edit/' + row.globalId + '"class="btn btn-sm btn-clean btn-icon" title="Edit details">\
        ...
        $('#setStatusActive').on('click', function () {
            ...
            if (datatable.nodes().length > 0) {
                ...
                console.log(data);
                $.ajax({
                    url: "admin/country/UpdateStatusRange/",
                    method: "Post",
                    data: data,
